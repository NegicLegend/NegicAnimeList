const animeList = [
   ...
   },
   {
      ...
      activeTag: ['Action', 'Fantasy', 'Comedy', 'Martial Art', 'Supernatural', 'Adventure', 'Science', 'Fiction'],
      active: true,
   },
   {
      animeindex: 4,
      ...
      name: 'Conan',
      tagS: 'Detective, Adventure, Comedy, Psychological',
   ...
   },
   {
      ...
      tagS: 'Game, Action, fantasy, Adventure, Harem, Romance',
      activeTag: ['Fantasy', 'Adventure', 'Action', 'Martial Art'],
      active: true,
   },
   {
      animeindex: 19,
   ...
   },
   {
      ...
      activeTag: ['Comedy', 'Fantasy', 'Comedy', 'Action', 'Adventure'],
      active: true,
   },
   {
      animeindex: 127,
   ...
   },
   {
      ...
      tagS: 'Food, Slice of Life, Comedy, School',
      activeTag: ['Food', 'Slice of Life', 'Comedy', 'School'],
      active: true,
   },
   {
      animeindex: 129,
   ...
   },
   {
      ...
      tagS: 'Drama, Action, Comendy, Psychological, Horror, Supernatural',
      activeTag: ['Drama', 'Action', 'Comendy', 'Psychological', 'Horror', 'Supernatural'],
      active: true,
   },
   {
      animeindex: 164,
   ...
   },
   {
      ...
      tagS: 'Action, Psychological, Horror',
      activeTag: ['Action', 'Psychological', 'Horror'],
      active: true,
   },
   {
      animeindex: 184,
   ...
   },
   {
      ...
      tagS: 'Comedy, Action, Historical, Adventure, Martial Art, Supernatural, Romance',
      activeTag: ['Comedy', 'Action', 'Historical', 'Adventure', 'Martial Art', 'Supernatural', 'Romance'],
      active: true,
   },
   {
      animeindex: 201,
   ...
   },
   {
      ...
      activeTag: ['Adventure', 'Action', 'Fantasy', 'Comedy'],
      active: true,
   },
   {
      animeindex: 229,
