const animeList = [
   {
      ...
      name: 'One Piece',
      tagS: 'Action, Adventure, Comedy, Psychological',
      activeTag: ['Action', 'Adventure', 'Comedy', 'Psychological'],
      active: true,
   },
   {
      animeindex: 2,
   ...
   },
   {
      ...
      tagS: 'Action, Mecha, Fantasy, Romance, Adventure',
      activeTag: ['Action', 'Mecha', 'Fantasy', 'Romance', 'Adventure'],
      active: true,
   },
   {
      animeindex: 112,
   ...
   },
   {
      ...
      tagS: 'Comedy, Slice of Life, Ecchi, Harem, Romance, Drama',
      activeTag: ['Comedy', 'Slice of Life', 'Ecchi', 'Harem', 'Romance', 'Drama',],
      active: true,
   },
   {
      animeindex: 121,
   ...
   },
   {
      ...
      tagS: 'Action, Comedy, School, Science Fiction, Romance',
      activeTag: ['Action', 'Comedy', 'School', 'Science Fiction', 'Romance'],
      active: true,
   },
   {
      animeindex: 130,
   ...
   },
   {
      ...
      activeTag: ['Fantasy', 'Supernatural', 'Comedy'],
      active: true,
   },
   {
      animeindex: 146,
   ...
   },
   {
      ...
      tagS: 'Supernatural, Psychological, Fantasy',
      activeTag: ['Supernatural', 'Psychological', 'Fantasy'],
      active: true,
   },
   {
      animeindex: 161,
   ...
   },
   {
      ...
      activeTag: ['Fantasy', 'Action', 'Adventure'],
      active: true,
   },
   {
      animeindex: 167,
   ...
   },
   {
      ...
      activeTag: ['Romance', 'Psychological'],
      active: true,
   },
   {
      animeindex: 192,
   ...
   },
   {
      ...
      tagS: 'Psychological, Slice of Life, Romance',
      activeTag: ['Psychological', 'Slice of Life', 'Romance'],
      active: true,
   },
   {
      animeindex: 194,
      ...
      name: 'Koe no Katachi',
      tagS: 'Psychological, Slice of Life, Romance, School',
      activeTag: ['Psychological', 'Slice of Life', 'Romance', 'School'],
      active: true,
   },
   {
      animeindex: 195,
      ...
      tagS: 'Psychological, School, Romance',
      activeTag: ['Psychological', 'School', 'Romance'],
      active: true,
   },
   {
      animeindex: 196,
   ...
   },
   {
      ...
      tagS: 'Slice of Life, Comedy, Romnance',
      activeTag: ['Slice of Life', 'Comedy', 'Romnance'],
      active: true,
   },
   {
      animeindex: 213,
      ...
      tagS: 'Comedy, Slice of Life, School, Romnance',
      activeTag: ['Slice of Life', 'Comedy', 'School', 'Romnance'],
      active: true,
   },
   {
      animeindex: 214,
      ...
      tagS: 'School, Romnance',
      activeTag: ['School', 'Romnance'],
      active: true,
   },
   {
      animeindex: 215,
   ...
   },
   {
      ...
      name: 'Sankarea',
      tagS: 'Drama, Comedy, Supernatural, Romnance',
      activeTag: ['Drama', 'Comedy', 'Supernatural', 'Romnance'],
      active: true,
   },
   {
      animeindex: 217,
      ...
      tagS: 'Drama, Fantasy, Adventure, Supernatural, Romnance',
      activeTag: ['Drama', 'Fantasy', 'Adventure', 'Supernatural', 'Romnance'],
      active: true,
   },
   {
      animeindex: 218,
   ...
   },
   {
      ...
      tagS: 'Fantasy, Action, Historical, Comedy, Supernatural, Adventure, Romance',
